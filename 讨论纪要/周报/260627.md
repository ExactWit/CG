...
3.两则笔记：[[Mesh分割调研及综述]]、[[网格测地线算法]]
 ...
 ![[Fusion360Seg.png]]
		β.[ShapeNet](http://download.cs.stanford.edu/orion/partnet_dataset/data_v0.zip)（~~等待审批~~正在下载）：面级语义标注，语义分割任务
	b.选定基线：
		α.B-Rep面级分类（CAD特征识别，工艺规划的上游）：
		[UV-Net，Autodesk, CVPR 2021](https://github.com/AutodeskAILab/UV-Net),
		[BrepNet, Autodesk, CVPR 2021](https://github.com/AutodeskAILab/BRepNet)
