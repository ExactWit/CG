...
| **<br><br>数据集<br><br>** | **<br><br>年份<br><br>** | **<br><br>表示类型<br><br>** | **<br><br>标注粒度<br><br>**    | **<br><br>规模<br><br>** | **<br><br>主要用途/定位<br><br>**        |
| ----------------------- | ---------------------- | ------------------------ | --------------------------- | ---------------------- | ---------------------------------- |
| **PartNet**​            | CVPR 2019              | 三角网格                     | 部件级（面级标签），24 大类             | 26,000+ 实例             | 监督 mesh part segmentation **主基准**​ |
| **ShapeNet-Part**​      | 2015                   | 三角网格                     | 部件级（较粗），16 类                | ~16,000 模型             | 经典对照 / 预训练来源                       |
| **COSEG**​              | 2012                   | 三角网格                     | 部件级，少量类别（吉他、椅子等）            | 少量                     | 跨类泛化性测试                            |
| **SHREC 人体部位**​         | 2007                   | 人体扫描网格                   | 身体部件（头/躯干/四肢）               | 中等                     | 人体分割评估                             |
| **Objaverse-XL**​       | 2023                   | 三角网格 / glTF              | **无部件标注**；仅有类别/元数据          | ~1,000,000 对象          | 3D 生成/检索/原料仓（非分割基准）                |
| **MeshFleet**​          | 2024–25                | 三角网格（通过 Objaverse 拉取）    | 车辆类别标注 + 多视角渲染；**无部件分割标注**​ | 子集（车辆类）                | Objaverse-XL 车辆子集封装，用于生成/外观评测      |
